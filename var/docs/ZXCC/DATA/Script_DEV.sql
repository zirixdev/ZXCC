...
-- Schema ZX_CC_DEV
-- ----------------------------------------------------------------------------
DROP SCHEMA IF EXISTS `ZX_CC_DEV` ;
CREATE SCHEMA IF NOT EXISTS `ZX_CC_DEV` ;

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TIPO_ENDERECO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TIPO_ENDERECO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DEFINED_PROCESS_STATE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DEFINED_PROCESS_STATE` (
  ...
  CONSTRAINT `FK_DEFINED_PROCESS_STATE_DEFINED_WORK_PROCESS_ID`
    ...
    REFERENCES `ZX_CC_DEV`.`DEFINED_PROCESS` (`PROCESS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CONTATO_CLIENTE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CONTATO_CLIENTE` (
  ...
  CONSTRAINT `FK_CONTATO_CLIENTE_CLIENTE_COD_CLIENTE`
    ...
    REFERENCES `ZX_CC_DEV`.`CLIENTE` (`COD_CLIENTE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_CONTATO_CLIENTE_TIPO_CONTATO_COD_CONTATO`
    FOREIGN KEY (`COD_CONTATO`)
    REFERENCES `ZX_CC_DEV`.`TIPO_CONTATO` (`COD_CONTATO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_CONTATO_CLIENTE_INFO_CONTATO_COD_GRAU`
    FOREIGN KEY (`COD_GRAU`)
    REFERENCES `ZX_CC_DEV`.`INFO_CONTATO` (`COD_GRAU`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TIPO_CONTATO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TIPO_CONTATO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DOCUMENTO_CLIENTE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DOCUMENTO_CLIENTE` (
  ...
  CONSTRAINT `FK_DOCUMENTO_CLIENTE_TIPO_DOCUMENTO_COD_DOCUMENTO`
    ...
    REFERENCES `ZX_CC_DEV`.`TIPO_DOCUMENTO` (`COD_DOCUMENTO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TIPO_DOCUMENTO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TIPO_DOCUMENTO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.VENDEDOR
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`VENDEDOR` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.ENDERECO_VENDEDOR
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`ENDERECO_VENDEDOR` (
  ...
  CONSTRAINT `FK_ENDERECO_VENDEDOR_VENDEDOR_COD_VENDEDOR`
    ...
    REFERENCES `ZX_CC_DEV`.`VENDEDOR` (`COD_VENDEDOR`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ENDERECO_VENDEDOR_PAIS_COD_PAIS`
    FOREIGN KEY (`COD_PAIS`)
    REFERENCES `ZX_CC_DEV`.`PAIS` (`COD_PAIS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_ENDERECO_VENDEDOR_TIPO_ENDERECO_COD_ENDERECO`
    FOREIGN KEY (`COD_ENDERECO`)
    REFERENCES `ZX_CC_DEV`.`TIPO_ENDERECO` (`COD_ENDERECO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CONTATO_VENDEDOR
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CONTATO_VENDEDOR` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.WORK_STATUS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`WORK_STATUS` (
  `WORK_STATUS_ID` INT NOT NULL AUTO_INCREMENT,
  `WORK_STATUS_NAME` CHAR(50) NOT NULL,
  PRIMARY KEY (`WORK_STATUS_ID`));

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DOCUMENTO_VENDEDOR
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DOCUMENTO_VENDEDOR` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.VEICULO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`VEICULO` (
  ...
  CONSTRAINT `FK_VEICULO_VEICULO_MARCA_COD_MARCA`
    ...
    REFERENCES `ZX_CC_DEV`.`VEICULO_MARCA` (`COD_MARCA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_VEICULO_VEICULO_COMBUSTIVEL_COD_COMBUSTIVEL`
    FOREIGN KEY (`COD_COMBUSTIVEL`)
    REFERENCES `ZX_CC_DEV`.`VEICULO_COMBUSTIVEL` (`COD_COMBUSTIVEL`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.VEICULO_MARCA
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`VEICULO_MARCA` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.VEICULO_COMBUSTIVEL
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`VEICULO_COMBUSTIVEL` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.NUMERO_OS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`NUMERO_OS` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.MODULO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`MODULO` (
  ...
  CONSTRAINT `FK_MODULO_DESC_MODULO_COD_MODELO`
    ...
    REFERENCES `ZX_CC_DEV`.`DESC_MODULO` (`COD_MODELO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_MODULO_CHIP_COD_CHIP`
    FOREIGN KEY (`COD_CHIP`)
    REFERENCES `ZX_CC_DEV`.`CHIP` (`COD_CHIP`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_MODULO_INSTALACAO_COD_INSTALACAO`
    FOREIGN KEY (`COD_INSTALACAO`)
    REFERENCES `ZX_CC_DEV`.`INSTALACAO` (`COD_INSTALACAO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_MODULO_ESTADO_MODULO_COD_ESTADO`
    FOREIGN KEY (`COD_ESTADO`)
    REFERENCES `ZX_CC_DEV`.`ESTADO_MODULO` (`COD_ESTADO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.OBS_OS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`OBS_OS` (
  ...
  CONSTRAINT `FK_OBS_OS_OS_COD_OS`
    FOREIGN KEY (`COD_OS`)
    REFERENCES `ZX_CC_DEV`.`OS` (`COD_OS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CHIP
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CHIP` (
  ...
  CONSTRAINT `FK_CHIP_OPERADORA_CHIP_COD_OPERADORA`
    ...
    REFERENCES `ZX_CC_DEV`.`OPERADORA_CHIP` (`COD_OPERADORA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_CHIP_STATUS_CHIP_COD_STATUS`
    FOREIGN KEY (`COD_STATUS`)
    REFERENCES `ZX_CC_DEV`.`STATUS_CHIP` (`COD_STATUS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.WORK_GROUP
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`WORK_GROUP` (
  `WORK_GROUP_ID` INT NOT NULL AUTO_INCREMENT,
  `WORK_GROUP_NAME` CHAR(50) NOT NULL,
  PRIMARY KEY (`WORK_GROUP_ID`));

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.OPERADORA_CHIP
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`OPERADORA_CHIP` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TESTES_OS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TESTES_OS` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.STATUS_CHIP
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`STATUS_CHIP` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.WORK_USER
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`WORK_USER` (
  ...
  CONSTRAINT `FK_WORK_USER_WORK_GROUP_WORK_GROUP_ID`
    ...
    REFERENCES `ZX_CC_DEV`.`WORK_GROUP` (`WORK_GROUP_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_WORK_USER_USUARIO_COD_USUARIO`
    FOREIGN KEY (`COD_USUARIO`)
    REFERENCES `ZX_CC_DEV`.`USUARIO` (`COD_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DESC_MODULO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DESC_MODULO` (
  ...
  CONSTRAINT `FK_DESC_MODULO_MARCA_MODULO_COD_MARCA`
    FOREIGN KEY (`COD_MARCA`)
    REFERENCES `ZX_CC_DEV`.`MARCA_MODULO` (`COD_MARCA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.MARCA_MODULO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`MARCA_MODULO` (
  `COD_MARCA` INT NOT NULL AUTO_INCREMENT,
  `NOME_MARCA` CHAR(50) NOT NULL,
  `DELETED` INT NOT NULL,
  PRIMARY KEY (`COD_MARCA`));
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.ESTADO_MODULO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`ESTADO_MODULO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CLIENTE_PROSPECCAO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CLIENTE_PROSPECCAO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.HIST_MODULO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`HIST_MODULO` (
  ...
  CONSTRAINT `FK_HIST_MODULO_MODULO_COD_MODULO`
    ...
    REFERENCES `ZX_CC_DEV`.`MODULO` (`COD_MODULO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `FK_HIST_MODULO_MOTIVO_HIST_MODULO_COD_MOTIVO`
    ...
    REFERENCES `ZX_CC_DEV`.`MOTIVO_HIST_MODULO` (`COD_MOTIVO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
...
-- Table ZX_CC_DEV.OS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`OS` (
  ...
  CONSTRAINT `FK_OS_NUMERO_OS_NUM_OS`
    FOREIGN KEY (`NUM_OS`)
    REFERENCES `ZX_CC_DEV`.`NUMERO_OS` (`NUM_OS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_OS_TECNICO_COD_TECNICO`
    FOREIGN KEY (`COD_TECNICO`)
    REFERENCES `ZX_CC_DEV`.`TECNICO` (`COD_TECNICO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CONTATO_PROSPECCAO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CONTATO_PROSPECCAO` (
  ...
  CONSTRAINT `FK_CONTATO_PROSPECCAO_CLIENTE_PROSPECCAO_COD_CLIENTE_PROSPECCAO`
    ...
    REFERENCES `ZX_CC_DEV`.`CLIENTE_PROSPECCAO` (`COD_CLIENTE_PROSPECCAO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.ESTOQUE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`ESTOQUE` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TELA
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TELA` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.EMAIL_PROSPECCAO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`EMAIL_PROSPECCAO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.PERMISSAO_USUARIO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`PERMISSAO_USUARIO` (
  ...
  CONSTRAINT `FK_PERMISSAO_USUARIO_TELA_COD_TELA`
    ...
    REFERENCES `ZX_CC_DEV`.`TELA` (`COD_TELA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.USUARIO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`USUARIO` (
  ...
  CONSTRAINT `FK_USUARIO_GRUPO`
    ...
    REFERENCES `ZX_CC_DEV`.`GRUPO` (`COD_GRUPO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.WORK_SERVICE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`WORK_SERVICE` (
  ...
  CONSTRAINT `FK_WORK_SERVICE_DEFINED_WORK_WORK_ID`
    FOREIGN KEY (`WORK_ID`)
    REFERENCES `ZX_CC_DEV`.`DEFINED_WORK` (`WORK_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.EMAIL_CLI_VEN
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`EMAIL_CLI_VEN` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.INFO_CONTATO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`INFO_CONTATO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.PEDIDO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`PEDIDO` (
  ...
  CONSTRAINT `FK_PEDIDO_TIPO_PEDIDO_COD_TIPO`
    ...
    REFERENCES `ZX_CC_DEV`.`TIPO_PEDIDO` (`COD_TIPO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TIPO_PEDIDO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TIPO_PEDIDO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.OBS_PEDIDO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`OBS_PEDIDO` (
  ...
  CONSTRAINT `FK_OBS_PEDIDO_PEDIDO_COD_PEDIDO`
    ...
    REFERENCES `ZX_CC_DEV`.`PEDIDO` (`COD_PEDIDO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.ANEXO_PEDIDO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`ANEXO_PEDIDO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TIPO_SERVICO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TIPO_SERVICO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.sysdiagrams
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`sysdiagrams` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.SERVICO_PEDIDO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`SERVICO_PEDIDO` (
  ...
  CONSTRAINT `FK_SERVICO_PEDIDO_TIPO_SERVICO_COD_SERVICO`
    ...
    REFERENCES `ZX_CC_DEV`.`TIPO_SERVICO` (`COD_SERVICO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.NUMERO_PEDIDO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`NUMERO_PEDIDO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.PERMISSAO_GRUPO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`PERMISSAO_GRUPO` (
  `COD_PERMISSAO` INT NOT NULL AUTO_INCREMENT,
  `COD_GRUPO` INT NOT NULL,
  `COD_TELA` INT NOT NULL,
  `CHAVE` INT NOT NULL,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DADOS_INSTALACAO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DADOS_INSTALACAO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.GRUPO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`GRUPO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.PERGUNTA_PROCEDIMENTO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`PERGUNTA_PROCEDIMENTO` (
  ...
  CONSTRAINT `FK_PERGUNTA_PROCEDIMENTO_TIPO_UNIDADE_COD_UNIDADE`
    ...
    REFERENCES `ZX_CC_DEV`.`TIPO_UNIDADE` (`COD_UNIDADE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.MOTIVO_HIST_MODULO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`MOTIVO_HIST_MODULO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CONTATO_PROCEDIMENTO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CONTATO_PROCEDIMENTO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CONTA_CHIP
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CONTA_CHIP` (
  `COD_CONTA` INT NOT NULL,
  `NUMERO_CONTA` CHAR(10) NOT NULL,
  `DELETED` INT NOT NULL);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.EQUIP_ACESSORIO_PEDIDO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`EQUIP_ACESSORIO_PEDIDO` (
  ...
  CONSTRAINT `FK_EQUIP_ACESSORIO_PEDIDO_TIPO_EQUIP_ACESSORIO_COD_EQUIP_ACESS1`
    ...
    REFERENCES `ZX_CC_DEV`.`TIPO_EQUIP_ACESSORIO` (`COD_EQUIP_ACESSORIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.PACOTE_CHIP
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`PACOTE_CHIP` (
  `COD_PACOTE` INT NOT NULL,
  `COD_CONTA` INT NOT NULL,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TIPO_EQUIP_ACESSORIO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TIPO_EQUIP_ACESSORIO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.INSTALACAO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`INSTALACAO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TIPO_UNIDADE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TIPO_UNIDADE` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.AGENDAMENTO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`AGENDAMENTO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.OBS_AGENDAMENTO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`OBS_AGENDAMENTO` (
  ...
  CONSTRAINT `FK_OBS_AGENDAMENTO_AGENDAMENTOCOD_AGENDAMENTO`
    ...
    REFERENCES `ZX_CC_DEV`.`AGENDAMENTO` (`COD_AGENDAMENTO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.SCHED_WORK
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`SCHED_WORK` (
  ...
  CONSTRAINT `FK_SCHED_WORK_DEFINED_PROCESS_STATE_STATE_ID`
    ...
    REFERENCES `ZX_CC_DEV`.`DEFINED_PROCESS_STATE` (`PROCESS_STATE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_SCHED_WORK_WORK_STATe_WORK_STATe_ID`
    FOREIGN KEY (`WORK_STATE_ID`)
    REFERENCES `ZX_CC_DEV`.`WORK_STATUS` (`WORK_STATUS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `FK_SCHED_WORK_RESTRICTION_WORD_RESTRICTION_ID`
    ...
    REFERENCES `ZX_CC_DEV`.`RESTRICTION_WORK` (`RESTRICTION_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_SCHED_WORK_SCHED_PROCESS_PROCESS_ID`
    FOREIGN KEY (`PROCESS_ID`)
    REFERENCES `ZX_CC_DEV`.`SCHED_PROCESS` (`PROCESS_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_SCHED_WORK_WORK_ALERT_WORK_ALERT_ID`
    FOREIGN KEY (`WORK_ALERT_ID`)
    REFERENCES `ZX_CC_DEV`.`WORK_ALERT` (`WORK_ALERT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DADOS_AGENDAMENTO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DADOS_AGENDAMENTO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.SCHED_PROCESS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`SCHED_PROCESS` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.WORK_ALERT
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`WORK_ALERT` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.UNIDADES_AGENDADAS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`UNIDADES_AGENDADAS` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.USER_GROUP_ALERT
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`USER_GROUP_ALERT` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.RESTRICTION_WORK
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`RESTRICTION_WORK` (
  `RESTRICTION_ID` INT NOT NULL AUTO_INCREMENT,
  `RESTRICTION_VALUE` TIME(6) NOT NULL,
  PRIMARY KEY (`RESTRICTION_ID`));

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.TECNICO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`TECNICO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.ENDERECO_TECNICO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`ENDERECO_TECNICO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CONTATO_TECNICO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CONTATO_TECNICO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DEFINED_WORK
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DEFINED_WORK` (
  `WORK_ID` INT NOT NULL AUTO_INCREMENT,
  `WORK_NAME` CHAR(50) NOT NULL,
  `PROCESS_ID` INT NOT NULL,
  `RESTRICTION_ID` INT NOT NULL,
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DOCUMENTO_TECNICO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DOCUMENTO_TECNICO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.DEFINED_PROCESS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`DEFINED_PROCESS` (
  `PROCESS_ID` INT NOT NULL AUTO_INCREMENT,
  `PROCESS_NAME` CHAR(50) NOT NULL,
  PRIMARY KEY (`PROCESS_ID`));

-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.EMAIL_TECNICO
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`EMAIL_TECNICO` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.CLIENTE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`CLIENTE` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.ENDERECO_CLIENTE
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`ENDERECO_CLIENTE` (
...
-- ----------------------------------------------------------------------------
-- Table ZX_CC_DEV.PAIS
-- ----------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `ZX_CC_DEV`.`PAIS` (
